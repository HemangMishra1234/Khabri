...
class LoginViewModel(private val auth: FirebaseAuth, private val service: AuthenticationService = AuthenticationServiceImpl()) : ViewModel() {
    ...
    fun forgotPassword(snackbarHostState: SnackbarHostState, navController: NavController, onSuccess: () -> Unit){
